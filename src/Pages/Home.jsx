...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/nhathao150" },
  { icon: Linkedin, link: "." },
  { icon: Instagram, link: "https://www.instagram.com/gumayubekk/" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "/animations/developer-skills.json",
    loop: true,
    autoplay: true,
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Create innovative, usable and user-friendly websites for digital solutions.
                </p>
